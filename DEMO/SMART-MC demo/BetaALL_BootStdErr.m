function BetaALLBootStdErr = BetaALL_BootStdErr (NumBootRep, X, TrtSeqMat, N)
...
for iter = 1:NumBootRep
    ...
    [CHat_Boot, NonNullPositions_Boot] = Non_Null_positions(SeqCell_Boot, N, p);
    
    objFunc_Boot = @(z) -log_likelihood_with_BetaShortVec(SeqCell_Boot, X_Boot,z,NonNullPositions_Boot, N);
