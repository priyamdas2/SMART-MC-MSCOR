...
if(DoBootstrapNow == 1)
    BetaALLBootStdErr_Naive = BetaALL_BootStdErr_Naive_2(NumBootRep, X, TrtSeqMat, N);
    filename = ['BetaALL_SIMULATION_BootStdErr_NonNormal_Naive_rep_',num2str(NumBootRep),'.mat'];
...
filename = 'Output_Simulation_NonNormal_CoeffsEst_Naive.csv';
...
filename = 'Output_Simulation_NonNormal_StdErr_Naive.csv';
