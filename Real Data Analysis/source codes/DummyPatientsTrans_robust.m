function M_dummy = DummyPatientsTrans_robust(XDummyPatient, SeqCell, X, BetaCell, N)
...
CountTol = CountTol_fun_robust(p); % minimum number of count to model it as function of covariates
